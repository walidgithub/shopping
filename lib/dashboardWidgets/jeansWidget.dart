...
import '../details/jeansdetails.dart';

class JeansWidget extends StatefulWidget {
  ...
  @override
  State<JeansWidget> createState() => _JeansWidgetState();
}

class _JeansWidgetState extends State<JeansWidget> {
