...
import '../models/accessoryDetailsData.dart';
import '../models/shirtsDetailsData.dart';
...
class ShirtsDetails extends StatefulWidget {
  ...
  @override
  _ShirtsDetailsState createState() => _ShirtsDetailsState();
}
            ...
            child:
              ...
              Container(
                  ...
                  child: ListView(scrollDirection: Axis.horizontal, children: [
                    SizedBox(width: 10),
                    buildOneItem(
                        shirtsdetailsdata[0].price,
                        shirtsdetailsdata[0].imagPath,
                        shirtsdetailsdata[0].desc),
                    SizedBox(
                      width: 20,
                    ),
                    buildOneItem(
                        shirtsdetailsdata[1].price,
                        shirtsdetailsdata[1].imagPath,
                        shirtsdetailsdata[1].desc),
                    SizedBox(width: 40),
                  ])),
              Row(children: [
                Container(
...
//   buildOneItem(
//                       accessorydetailsdata[0].price,
//                       accessorydetailsdata[0].imagPath,
//                       accessorydetailsdata[0].desc)
}
