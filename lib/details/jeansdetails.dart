...
import '../models/jeansDetailsData.dart';
            ...
            child:
              ...
              Container(
                  ...
                  child: ListView(scrollDirection: Axis.horizontal, children: [
                    SizedBox(width: 10),
                    buildOneItem(jeansdetailsdata[0].price,
                        jeansdetailsdata[0].imagPath, jeansdetailsdata[0].desc),
                    SizedBox(
                      width: 20,
                    ),
                    buildOneItem(jeansdetailsdata[1].price,
                        jeansdetailsdata[1].imagPath, jeansdetailsdata[1].desc),
                    SizedBox(width: 40),
                  ])),
              Row(children: [
                Container(
