...
import '../models/shoesDetailsData.dart';
            ...
            child:
              ...
              Container(
                  ...
                  child: ListView(scrollDirection: Axis.horizontal, children: [
                    SizedBox(width: 10),
                    buildOneItem(shoesdetailsdata[0].price,
                        shoesdetailsdata[0].imagPath, shoesdetailsdata[0].desc),
                    SizedBox(
                      width: 20,
                    ),
                    buildOneItem(shoesdetailsdata[1].price,
                        shoesdetailsdata[1].imagPath, shoesdetailsdata[1].desc),
                    SizedBox(width: 40),
                  ])),
              Row(children: [
                Container(
