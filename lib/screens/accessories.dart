...
class _AccessoriesState extends State<Accessories> {
  ...
  Widget build(BuildContext context) {
    return ListView(children: [
      buildListItem('assets/images/accessory1.png',
          ColorPalette().secondSlice, 'Shop Number One', 100, 3),
      buildListItem('assets/images/accessory2.png',
          ColorPalette().firstSlice, 'Shop Number Two', 40, 4)
    ]);
  }
