...
import 'package:shopping/details/shirtsdetails.dart';
...
class _ShirtsState extends State<Shirts> {
  ...
  Widget build(BuildContext context) {
    return ListView(children: [
      buildListItem('assets/images/shirt4.png',
          ColorPalette().secondSlice, 'Shop Number One', 70, 4),
      buildListItem('assets/images/shirt2.png',
          ColorPalette().firstSlice, 'Shop Number Two', 85, 2)
    ]);
  }
